...
source("/code/code.for.benchmarking/Software_source_code/RaceID2_StemID_class.R")
library(Seurat)
library(dplyr)
library(fpc)
...
## Save result
## -----------------------------
write.csv(result,file = paste0("/results/RaceID2_", Celltype, ".csv"),row.names = TRUE)
