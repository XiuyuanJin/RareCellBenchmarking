...
P1.seurat.obj <- PrepareData(P1.seurat.obj, n.HVG = 4000, n.PC = 15, which.dim.reduc = "umap",  = 629)
...
## Save result
## -----------------------------
write.csv(result,file = paste0(output_dir, "/SCISSORS_", Celltype, ".csv"),row.names = TRUE)
