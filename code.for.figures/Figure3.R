...
p1
ggsave(p1, filename = "/results/Fig3a.line.prop.F1.pdf",width= 6, height= 5, units='in')
...
p2 <- ggplot(benchmark_prop, aes(x = PrecRare, y = precision, color = Method, group = Method)) +
  ...
  theme(legend.position = "right",
        ...
        axis.text.y = element_text(color = "black", size = 10))
p2
ggsave(p2, filename = "/results/Fig3b.line.prop.precision.pdf",width= 6, height= 5, units='in')
...
p3 <- ggplot(benchmark_prop, aes(x = PrecRare, y = recall, color = Method, group = Method)) +
  ...
  theme(legend.position = "right",
        ...
        axis.text.y = element_text(color = "black", size = 10))
p3
ggsave(p3, filename = "/results/Fig3c.line.prop.recall.pdf",width= 6, height= 5, units='in')
...
load("/data/benchmarking.result.scCAD.RData")
...
p4 <- ggplot(benchmark_prop, aes(x = PrecRare, y = precision, color = Method, group = Method)) +
  ...
  theme(legend.position = "right",
        ...
        axis.text.y = element_text(color = "black", size = 10))
p4
ggsave(p4, filename = "/results/Fig3d.line.scCAD.precision.pdf",width= 6, height= 5, units='in')
...
p5 <- ggplot(benchmark_prop, aes(x = PrecRare, y = recall, color = Method, group = Method)) +
  ...
  theme(legend.position = "right",
        ...
        axis.text.y = element_text(color = "black", size = 10))
p5
ggsave(p5, filename = "/results/Fig3e.line.scCAD.recall.pdf",width= 6, height= 5, units='in')
...
p6 <- ggplot(benchmark_prop, aes(x = PrecRare, y = F1, color = Method, group = Method)) +
  ...
  theme(legend.position = "right",
        ...
        axis.text.y = element_text(color = "black", size = 10))
p6
ggsave(p6, filename = "/results/Fig3f.line.scCAD.F1.pdf",width= 6, height= 5, units='in')
