...
pdf("/results/Fig4a.Spearman_heatmap.pdf", width = 6, height = 5.5)
...
p1 <- ggplot(scissors_box, aes(x = PrecRare, y = median_F1, fill = Silhouette_group)) +
  ...
  theme(axis.text = element_text(size = 11, color = "black"),
        ...
        legend.position = "top")
p1
ggsave(p1, filename = "/results/Fig4b.scissors.box.pdf",width= 4.5, height = 4.5, units='in')
...
p2
ggsave(p2, filename = "/results/Fig4c.volcano.gamma.pdf",width= 4.5, height = 4.5, units='in')
...
p3
ggsave(p3, filename = "/results/Fig4d.scCAD.silhouette.precision.pdf",width= 13, height= 2.2, units='in')
...
p4
ggsave(p4, filename = "/results/Fig4d.scCAD.silhouette.recall.pdf",width= 13, height= 2.2, units='in')
