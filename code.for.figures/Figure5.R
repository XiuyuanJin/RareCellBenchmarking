...
p1
ggsave(p1, filename = "/results/Fig5a.time.pdf",width= 8, height= 5, units='in')
...
p2
ggsave(p2, filename = "/results/Fig5b.time.datasize.pdf",width= 6, height= 4, units='in')
...
p3
ggsave(p3, filename = "/results/Fig5c.time.datasize.pdf",width= 9, height= 4, units='in')
